...
# CST-537       Tom Donaldson   Copy to mast-aladin, return ref_aperture,
#                               truncate long lines
###############################################################
# Imports
...
def defineApertures(selectedTelescope, selectedInstrument, selectedAperture):
    ...
    # Create lists of individual apertures that make up selected
    # instrument FOV and get v2,v3 of reference point
    apertureList = []
    ref_aperture = None
    ...
    if selectedTelescope.lower() == 'roman':
        ...
        if selectedInstrument.lower() == 'wfi':
            if selectedAperture.lower() == 'all':
                apertureNames = [
                    'WFI01_FULL', 'WFI02_FULL', 'WFI03_FULL', 'WFI04_FULL',
                ...
                ref_aperture = telescopeSiaf.apertures['WFI_CEN']
                V2Ref = ref_aperture.V2Ref
                V3Ref = ref_aperture.V3Ref
            else:
                apertureNames = [selectedAperture]
                ref_aperture = telescopeSiaf.apertures[selectedAperture]
                V2Ref = ref_aperture.V2Ref
                V3Ref = ref_aperture.V3Ref
        elif selectedInstrument.lower() == 'cgi':
            apertureNames = ['CGI_CEN']
            ref_aperture = telescopeSiaf.apertures['CGI_CEN']
            V2Ref = ref_aperture.V2Ref
            V3Ref = ref_aperture.V3Ref
            ...
            apertureNames = [
                ...
                'WFI09_FULL', 'WFI10_FULL', 'WFI11_FULL', 'WFI12_FULL',
                'WFI13_FULL', 'WFI14_FULL', 'WFI15_FULL', 'WFI16_FULL',
                'WFI17_FULL', 'WFI18_FULL', 'BORESIGHT', 'CGI_CEN',
            ]
            ref_aperture = telescopeSiaf.apertures['BORESIGHT']
            V2Ref = ref_aperture.V2Ref
            V3Ref = ref_aperture.V3Ref
        else:
        ...
        if selectedInstrument.lower() == 'fgs':
            ...
            if selectedAperture.lower() == 'all':
                apertureNames = [
                    'NRCA1_FULL', 'NRCA1_FULL', 'NRCA3_FULL',
                    'NRCA4_FULL', 'NRCA5_FULL', 'NRCB1_FULL',
                    'NRCB1_FULL', 'NRCB3_FULL', 'NRCB4_FULL', 'NRCB5_FULL',
                ]
                V2Ref = 0.0
                V3Ref = -500.0
            else:
        ...
        if selectedInstrument.lower() == 'acs':
            if selectedAperture.lower() == 'all':
                ...
                ref_aperture = telescopeSiaf.apertures['JWFCENTER']
                V2Ref = ref_aperture.V2Ref
                V3Ref = ref_aperture.V3Ref
            else:
                apertureNames = [selectedAperture]
            ...
            if selectedAperture.lower() == 'all':
                ...
                ref_aperture = telescopeSiaf.apertures['LFMAC']
                V2Ref = ref_aperture.V2Ref
                V3Ref = ref_aperture.V3Ref
            else:
                apertureNames = [selectedAperture]
            ...
            if selectedAperture.lower() == 'all':
                ...
                ref_aperture = telescopeSiaf.apertures['NIC1']
                V2Ref = ref_aperture.V2Ref
                V3Ref = ref_aperture.V3Ref
            else:
                apertureNames = [selectedAperture]
            ...
            if selectedAperture.lower() == 'all':
                ...
                ref_aperture = telescopeSiaf.apertures['OVIS']
                V2Ref = ref_aperture.V2Ref
                V3Ref = ref_aperture.V3Ref
            else:
                apertureNames = [selectedAperture]
            ...
            if selectedAperture.lower() == 'all':
                ...
                ref_aperture = telescopeSiaf.apertures['IIR']
                V2Ref = ref_aperture.V2Ref
                V3Ref = ref_aperture.V3Ref
            else:
                apertureNames = [selectedAperture]
    ...
    return apertureList, V2Ref, V3Ref, ref_aperture
###############################################################
...
def getVertices(apertureSiaf):
    ...
    if (
        apertureSiaf.observatory == 'HST'
        and (
            apertureSiaf.AperShape == 'QUAD' or apertureSiaf.AperShape == 'RECT'
        )
    ):
        xVertices = np.array(
...
def computeStcsFootprint(apertureSiaf, skyRa, skyDec):
    if apertureSiaf.AperShape == 'QUAD' or apertureSiaf.AperShape == 'RECT':
        apertureSregion = (
            'POLYGON ICRS {:.8f} {:.8f} {:.8f} {:.8f} '
            '{:.8f} {:.8f} {:.8f} {:.8f} '
        ).format(
            skyRa[0], skyDec[0], skyRa[1], skyDec[1],
            skyRa[2], skyDec[2], skyRa[3], skyDec[3],
        )
