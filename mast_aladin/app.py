...
class MastAladin(Aladin, DelayUntilRendered, AIDA):
    ...
    def add_table(
        ...
        **catalog_options
        ...
        performance_catalog : instance of `~mast_aladin.catalogs.catalogs.PerformanceCatalog`, False, None
            Setting to False will prevent any performance catalog from being generated automatically.
